                                    ...
                                    <div id="content">
                                        <ul class="timeline">
                                            <li class="event" data-date="Quarter 1">
                                                ...
                                                <p>The most fun part of our roadmap... launching our new cryptocurrency.
                                                Our goal is to launch, establish our digital footprint on social media, and get
                                                listed on exchanges such as CoinMarketCap and CoinGecko. Our
                                            ...
                                            <li class="event" data-date="Quarter 3">
                                                <h3>Scale</h3>
                                                <p>In quarter 3 our goal is to scale Nobility team and competitions. Maintain token utility
                                                and establish more exchanges. We also plan on establishing Nobility as a
                                                payment option on other platforms, such as Twitch, Blizzard, Steam,
                                                and organizations alike. In Q3 we also intend to integrate Noble players and contracts onto
                                            ...
                                            <li class="event" data-date="Quarter 4">
                                                ...
                                                brand, we plan on introducing annual Nobility LAN tournaments that will spotlight
                                                the biggest esports content creators and influencers for a significant prize pool. We plan on
